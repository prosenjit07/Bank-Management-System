...
class Account:
    ...
    def createAccount(self):
        ...
        self.accNo = randint(1005, 9999)
        self.name = input("Enter the account holder name : ")
        self.type = input("Enter the type of account(Checking accounts/Savings accounts) Type[C or S] : ")
...
def intro():
    #print("\t\t\t\t\t*****Welcome to BANK MANAGEMENT SYSTEM developed by DIU_CodeBit*****")
...
num = 0
intro()
password = int(input("Enter the password to log in!"))
if(password == 123):
